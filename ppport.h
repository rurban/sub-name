...
static void DPPP_(my_gv_init_pv)(pTHX_ GV * gv, HV * stash, const char * name, U32 flags);
static
#else
extern void DPPP_(my_gv_init_pv)(pTHX_ GV * gv, HV * stash, const char * name, U32 flags);
#endif
...
static void DPPP_(my_gv_init_pvn)(pTHX_ GV * gv, HV * stash, const char * name, STRLEN len, U32 flags);
static
#else
extern void DPPP_(my_gv_init_pvn)(pTHX_ GV * gv, HV * stash, const char * name, STRLEN len, U32 flags);
#endif
...
static void DPPP_(my_gv_init_sv)(pTHX_ GV * gv, HV * stash, SV * namesv, U32 flags);
static
#else
extern void DPPP_(my_gv_init_sv)(pTHX_ GV * gv, HV * stash, SV * namesv, U32 flags);
#endif
